/**
  ...
  ******************************************************************************
  */
#ifndef AI_MODELLITE_H
#define AI_MODELLITE_H

#include "modellite_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODELLITE_MODEL_NAME          "modellite"
#define AI_MODELLITE_ORIGIN_MODEL_NAME   "modellite"

/******************************************************************************/
#define AI_MODELLITE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODELLITE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODELLITE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODELLITE_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODELLITE_IN \
  ai_modellite_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODELLITE_IN_SIZE { \
  AI_MODELLITE_IN_1_SIZE, \
}
#define AI_MODELLITE_IN_SIZE_BYTES { \
  AI_MODELLITE_IN_1_SIZE_BYTES, \
}
#define AI_MODELLITE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODELLITE_IN_1_HEIGHT      (35)
#define AI_MODELLITE_IN_1_CHANNEL     (13)
#define AI_MODELLITE_IN_1_SIZE        (455)
#define AI_MODELLITE_IN_1_SIZE_BYTES  (1820)

/******************************************************************************/
#define AI_MODELLITE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODELLITE_OUT \
  ai_modellite_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODELLITE_OUT_SIZE { \
  AI_MODELLITE_OUT_1_SIZE, \
}
#define AI_MODELLITE_OUT_SIZE_BYTES { \
  AI_MODELLITE_OUT_1_SIZE_BYTES, \
}
#define AI_MODELLITE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODELLITE_OUT_1_CHANNEL     (15)
#define AI_MODELLITE_OUT_1_SIZE        (15)
#define AI_MODELLITE_OUT_1_SIZE_BYTES  (60)

/******************************************************************************/
#define AI_MODELLITE_N_NODES (8)
 ...
 * @ref ai_modellite_create. Both the activations memory buffer 
 ...
 * using @ref ai_modellite_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_modellite_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_modellite_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODELLITE_*
 * defines into file @ref modellite.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_modellite_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODELLITE_H */
